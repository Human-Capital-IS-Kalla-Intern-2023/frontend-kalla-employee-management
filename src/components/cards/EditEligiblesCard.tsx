      ...
      <div className="max-w-screen-xl px-4 mx-auto">
        <div className="relative overflow-hidden bg-green-500 shadow-profile sm:rounded-lg">
          <div className="px-5 pt-4 pb-4 overflow-x-auto">
            ...
            {/* card 1 */}
            <div className="flex w-full px-2 py-2 pb-2 overflow-hidden bg-red-100 rounded-lg shadow-lg">
                ...
                <table className="w-full p-5 table-auto">
                  ...
                  <tbody>
                    <tr className="flex flex-row">
                      {/* Kolom 1 */}
                      <td className="flex items-center px-4 py-2 text-left align-top">
                        <h2 className="mt-2 mr-2 text-base">
                      ...
                      {/* Kolom 2 */}
                      <td className="flex flex-row px-4 py-2 text-left align-top">
                        <h2 className="mt-2 mr-2 text-base">
